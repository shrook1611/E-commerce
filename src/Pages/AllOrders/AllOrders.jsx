...
export default function AllOrders() {
  ...
  return (
    <div>
      <div className=" m-5">
        <h3 className="text-center text-green-600 font-bold text-2xl m-3">All Orders</h3>
      </div>
    ...
    {order.isDelivered?  <td className="px-6 py-4">
 ...
 {order.paymentMethodType=='cash'?  <td className="px-6 py-4">
              <a
                href="#"
