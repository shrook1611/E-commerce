...
import { getProducts, productReducer } from "./../../redux/productSlice";
...
{data.map((product)=>{
  return<div key={product.id} className="p-5  sm:w-full md:w-1/2 lg:w-1/5 product ">
...
<h4 className=" font-bold font-2xl text-green-700 text-center">{product.title.split(' ').slice(0,3).join(' ')}</h4>
